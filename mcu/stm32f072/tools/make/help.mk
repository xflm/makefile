...
ifeq ($(findstring zh, $(LANG)),)
	@echo -e \
"$(PRINT_BOLD)Usage:$(PRINT_COLOR_OFF) make [all(default) clean clone debug files help qt slim tags]\n\
...
===== version: v2.0.0 author: xflm date: Sat Dec 19 09:11:46 CST 2020 ======"
	...
	@echo -e \
"$(PRINT_BOLD)使用：$(PRINT_COLOR_OFF) make [all(default) clean clone debug files help qt slim tags]\n\
$(PRINT_BOLD)-- all:$(PRINT_COLOR_OFF)\n\
